! function(e, t) {
	...
	return webpackJsonp([1], {
		...
		254: function(e, t, o) {
			...
			t["a"] = h, h.DEFAULT_TIMEOUT = 30 * 1e3, h.DEFAULT_MOUSE_SPEED = 10, h.RIGHT_MOUSE_CLICK = 2, h.decorateFunctionWithTimeout = function(e, t, o) {
			...
			}, h.prototype.doWaitForText = function(e, t) {
				return function(e, t, o, n, r) {
					if (!n) throw new Error("Timeout not specified.");
					return new Promise(function(i, s) {
						let l, a = 0,
							u = 100,
							c = setInterval(function() {
								a > n && (clearInterval(c), s(r));
								try {
									l = e(t, o)
								} catch (e) {
									clearInterval(c), s(e.message)
								}
								l ? l && (clearInterval(c), i()) : a += u
							}, u)
					})
				}(function(e, t) {
					try {
						return this.isText(e, t)
					} catch (e) {
						return !1
					}
				}.bind(this), e, t, this.defaultTimeout, "Element did not have text within the timeout specified.")
				...
				r.a.runtime.sendMessage({
					log: {
						type: "warn",
						message: "submit is deprecated and will be removed from later versions of TAF Recorder, please re-record the step."
					}
				});
				let t = this.browserbot.findElement(e);
				...
				return !0
			}, h.prototype.isText = function(e, t) {
				let o = this.browserbot.findElement(e);
				return c["a"].dom.getVisibleText(o).trim() === t
